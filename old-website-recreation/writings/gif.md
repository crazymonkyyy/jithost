# How I made my website gif-Using D
...
![vomiting pixels at a wizard to make a gif](/images/wizard.gif)
...
![pixely and bad shifting gradent](/images/gradent.gif)

## Voronoi diagrams and growing circles

![circles growing into a voronoi diagram](/images/layer1.gif)
...
![nonsense diagram I thought may make things clearer idk](/images/diagram.gif)
...
![random circles spawning in](/images/layer2.gif)
...
![graph of the above code, with a croped synced version of the gif](/images/graph.gif)
...
So gifs are a list of pictures and you can just change the timings, so I found the website [https://ezgif.com/](https://ezgif.com/) and started deleting frames and made some key frames longer, such as the first one; giving your computer time to get a head start to download the image and getting it down to 357.8 kb
